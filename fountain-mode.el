...
(defcustom fountain-export-include-elements
  '(("screenplay" scene-heading action character character-dd lines lines-dd paren paren-dd trans center page-break include)
    ("teleplay" section-heading scene-heading action character character-dd lines lines-dd paren paren-ddtrans center page-break include)
    ("stageplay" section-heading scene-heading action character character-dd lines lines-dd paren paren-dd trans center page-break include))
